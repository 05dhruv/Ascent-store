  ...
  return (
    <div className="min-h-screen overflow-y-auto lg:h-screen lg:overflow-hidden bg-slate-50 text-slate-900">
      <div className="grid min-h-screen lg:h-screen lg:grid-cols-[1.02fr_0.98fr]">
        <section className="hidden lg:flex relative overflow-hidden bg-gradient-to-br from-[#14212c] via-[#263746] to-[#5d2b2b] px-6 py-6 text-white lg:px-8 lg:py-6 flex-col justify-between">
          ...
          <div className="relative flex h-full flex-col justify-between gap-5">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                />
                <p className="mt-1 text-[10px] leading-tight text-red-100/70">
                  {brandTagline}
                </p>
              </div>
              ...
              <div className="hidden items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 backdrop-blur sm:flex">
                ...
                <span className="text-[10px] font-medium text-red-50/90">
                  Static preview
                </span>
              </div>
            </div>
                ...
                <div className="grid gap-2.5 sm:grid-cols-2">
                  {highlights.map((item) => (
                    ...
                    >
                      ...
                      <p className="mt-1 text-[10.5px] leading-4 text-red-50/70">
                        {item.text}
                      </p>
                    </div>
                  ))}
            ...
            <div className="relative max-w-xl rounded-3xl border border-white/10 bg-white/5 p-3.5 shadow-[0_24px_70px_rgba(2,8,23,0.2)] backdrop-blur">
              ...
              <p className="mt-2.5 text-[10.5px] leading-4 text-red-50/70">
                One place for receipt, transfer, site acknowledgement and
        ...
        <section className="flex flex-col items-center justify-center px-4 py-8 sm:px-6 lg:px-8 lg:py-6">
          {/* Mobile brand header */}
          <div className="lg:hidden mb-5 flex flex-col items-center text-center">
            ...
            />
            <p className="mt-1 text-[11px] text-slate-500 font-medium max-w-xs">
              {brandTagline}
            </p>
          </div>
