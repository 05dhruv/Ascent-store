...
const STOCK_VALIDATION_SCHEMA_VERSION = 1;

export const ensureStockValidationSchema = makeSchemaEnsurer("stock_validation", STOCK_VALIDATION_SCHEMA_VERSION, async () => {
  await query(`
