...
const STOCK_OUT_SCHEMA_VERSION = 2;

export const ensureStockOutSchema = makeSchemaEnsurer('stock_out', STOCK_OUT_SCHEMA_VERSION, async () => {
  await query(`
    ...
    ALTER TABLE stock_out
      ADD COLUMN IF NOT EXISTS source_id INTEGER REFERENCES stores(id),
    ...
    UPDATE stock_out
    SET source_id = destination_id
    WHERE source_id IS NULL AND destination_id IS NOT NULL;
    ...
    CREATE INDEX IF NOT EXISTS idx_stock_out_source_id ON stock_out(source_id);
