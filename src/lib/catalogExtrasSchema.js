    ...
    globalForCatalogExtras._catalogExtrasSchemaReadyPromise = (async () => {
      ...
      await query(`
        ALTER TABLE product_saleability
          ...
          ADD COLUMN IF NOT EXISTS franchise_cost NUMERIC(18, 9),
      ...
      await query(`
        ALTER TABLE product_saleability
          ...
          ALTER COLUMN franchise_cost TYPE NUMERIC(18, 9) USING franchise_cost::numeric;
      `);
      await query(`
        WITH ranked AS (
          SELECT id,
