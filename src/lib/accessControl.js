...
const ITEM_PERMISSION_RULES = {
  "/inventory/movement-tracker": ["MANAGE_INVENTORY", "VIEW_INVENTORY"],
  "/": ["ACCESS_DASHBOARD"],
  "/home": ["ACCESS_DASHBOARD"],
  ...
  "/settings/inventory/system-attributes": [
    "MANAGE_STORES",
    "MANAGE_INVENTORY",
  ],
  "/settings/inventory/custom-attributes": [
    "MANAGE_STORES",
    "MANAGE_INVENTORY",
  ],
...
const ROUTE_PERMISSION_RULES = [
  ...
  {
    prefix: "/reports/inventory/stock-level",
    permissions: [
      "VIEW_FINANCIAL_REPORTS",
      "VIEW_STORE_REPORTS",
      "VIEW_STORE_PRODUCT_INVENTORY",
  ...
  {
    prefix: "/reports/accounting/store-wise-tax-breakup",
    permissions: ["VIEW_TAX_WISE_REPORTS"],
  },
  {
    prefix: "/reports/accounting",
    permissions: [
      "VIEW_FINANCIAL_REPORTS",
      "VIEW_STORE_REPORTS",
      "VIEW_STORE_ACCOUNTING",
