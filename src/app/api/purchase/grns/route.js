...
export async function POST(request) {
  try {
    ...
    try {
      ...
      const insertText = `
        INSERT INTO stock_in (method, destination_id, apply_taxes, add_products_prefill, meta, status, reference_type, reference_id, vendor_id, vendor_name, invoice_number, invoice_date, created_by, created_at)
        VALUES ($1, $2, $3, $4, $5, 'draft', 'purchase_order', $6, $7, $8, $9, $10, $11, NOW())
        RETURNING id`;
